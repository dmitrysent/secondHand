...
const renderList = (cart) => {
  ...
  cart.map(({
    ...
    li.insertAdjacentHTML('beforeend', `
      <img src="${image}" alt="${title}" class="modal-cart__img" />
              ...
              <p class="props__description">${id}</p>
                ...
                <li class="props__item">
                  ...
                  <div class="props__description">
                    <button class="props__btn props__btn_minus" type="button" data-id="${id}">
                      -
                    </button>
                    <output class="props__count" name="count">${obj.count}</output>
                    <button class="props__btn props__btn_plus" type="button" data-id="${id}">
                      +
                    </button>
                  </div>
                </li>
